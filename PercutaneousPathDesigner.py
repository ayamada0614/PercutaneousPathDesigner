...
class PercutaneousPathDesigner:
  def __init__(self, parent):
    ...
    See <a href=http://www.slicer.org/slicerWiki/index.php/Documentation/Nightly/Extension/PercutaneousApproachAnalysis>the online documentation</a> to know how to use in detail.
